This project was created as a learning experience using [Create React App](https://github.com/facebookincubator/create-react-app), [Redux](http://redux.js.org/), [React-Redux](https://github.com/reactjs/react-redux), [Bootstrap](http://getbootstrap.com/), and [React Bootstrap]().

## Goals

- Learn by doing without a tutorial series guiding me.
- Solve problems the way I understand at first and then improve on naive solutions with
research. This offers a clear view of where I am currently limited while increasing my logical and technological skills.
- Learn best practices in React/Redux.
